...
namespace BaiTapLon.KetNoiCSDL
{
    class ThaoTacVoiCSDL
    {
        //Khai báo biến toàn cục, bạn phải thay đổi chuối kết nối phù hợp
        string strConnect = "Data Source=LAPTOP-A4GODJ3H\\TRANQUANGPHUONG;Initial Catalog=QuanLyBHMayAnh;Integrated Security=True";
